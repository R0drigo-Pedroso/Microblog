...
$dados = $noticia->listarUm();
    ...
    if(isset($_POST['atualizar'])){
        ...
        /* Se o campo da imagem estiver vazio, então significa que o usuario NÃO QUER TROCAR DE IMAGEM. Ou seja, vamos manter a imagem existente */
        if(empty($_FILES['imagem']['name'])){
            $noticia->setImagem($_POST['imagem-existente']);
        }else{
            /* Senão, Então pegamos a referência (nome e extersão) da nova imagem e fazemos o processo de upload e envio desta referência para o objeto */
